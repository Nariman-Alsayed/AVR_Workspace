...
{
	 MDIO_voidSetPinValue(A_u8PortNo, A_u8secondPinNo, LOW);  //Set Pin A1 to Low
	 MDIO_voidSetPinValue(A_u8PortNo, A_u8firstPinNo, HIGH);
}

void HDCMOTOR_voidfunctionUntiClockWise(u8 A_u8PortNo, u8 A_u8firstPinNo, u8 A_u8secondPinNo)
{
	MDIO_voidSetPinValue(A_u8PortNo, A_u8firstPinNo, LOW);
	MDIO_voidSetPinValue(A_u8PortNo, A_u8secondPinNo, HIGH); //Set Pin A1 to High
}
