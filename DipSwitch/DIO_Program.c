...
u8   MDIO_u8GetPortValue(u8 A_u8PortNo)
{
	...
	if(A_u8PortNo <= PORTD)
	{
		switch (A_u8PortNo)
		{
		case PORTA: local_u8PinValue = DIO_PINA_REG; break;
		case PORTB: local_u8PinValue = DIO_PINB_REG; break;
		case PORTC: local_u8PinValue = DIO_PINC_REG; break;
		case PORTD: local_u8PinValue = DIO_PIND_REG; break;
		}
	}
